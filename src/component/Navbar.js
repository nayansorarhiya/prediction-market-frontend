    ...
    return(
        ...
        <div className='body-color'>
           ...
           <div class="container-full">
            <nav className="navbar navbar-light pancake">
                <span className="navbar-brand mb-0 h1 cakeicon d-flex">
                    <div>
                    ...
                    <div className='pan-logo ms-2'>PancakeSwap</div> 
                </span>
                <span className='connect'> <Button variant="info" className='connectbtn' >Connect Wallet</Button></span>
            </nav>
            </div>
        </>
    );
